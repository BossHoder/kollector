...
export function PublicLayout() {
  return (
    <div className="min-h-screen flex flex-col bg-background-dark text-white antialiased relative overflow-x-hidden selection:bg-primary selection:text-background-dark">
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col items-center justify-center p-4 sm:p-6 w-full relative z-0">
        {/* Background Decorations */}
        <div className="absolute inset-0 z-[-1] overflow-hidden">
          <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-primary/5 rounded-full blur-[120px]" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] bg-[#3b5450]/20 rounded-full blur-[100px]" />
        </div>
