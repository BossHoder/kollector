...
const assetSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ['draft', 'processing', 'partial', 'active', 'failed'], default: 'draft', index: true },
  ...
  images: {
    ...
    processed: { url: String, publicId: String, bytes: Number, processedAt: Date },
